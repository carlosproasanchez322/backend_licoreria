...
let InventarioController = class InventarioController {
    ...
    kardex(idProducto) {
        return this.inventarioService.kardex(idProducto ? Number(idProducto) : undefined);
    }
    movimiento(dto) {
...
__decorate([
    ...
    __param(0, (0, common_1.Query)('idProducto')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], InventarioController.prototype, "kardex", null);
__decorate([
    (0, common_1.Post)('movimiento'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [movimiento_inventario_dto_1.MovimientoInventarioDto]),
    __metadata("design:returntype", void 0)
